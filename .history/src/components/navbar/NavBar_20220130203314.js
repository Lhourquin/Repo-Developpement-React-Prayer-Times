...
export const NavBar = () => {
  ...
  return (
    <nav className="NavBar__nav" style={(buttonBurgerIsClicked ? {}: {height : 128})}>
      ...
      <ul
        className={
          "NavBar__nav__ul " +
          (buttonBurgerIsClicked ? "closeNavigation" : "openNavigation navbar-collapse navbar-collapse.in")
        }
      >
