...
export const NavBar = () => {
  ...
  return (
    <nav className="NavBar__nav" style={(buttonBurgerIsClicked ? {transition: "width 0.2s, height 0.2s, transform 2s" }: {height : 128, transition: "width 0.1s, height 0.1s, transform 2s" })}>
