...
export const NavBar = () => {
  ...
  return (
    <nav className="NavBar__nav" style={(buttonBurgerIsClicked ? {transition: "width 0.2s, height 0.5s, transform 2s" }: {height : 128, transition: "width 1s, height 1s, transform 2s" })}>
