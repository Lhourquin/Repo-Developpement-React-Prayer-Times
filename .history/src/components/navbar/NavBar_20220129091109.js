...
export const NavBar = () => {
    ...
    const [buttonBurgerisClicked, setButtonBurgerIsClicked] = (false);

    
    const handleNavButtonBurger = () => {
        setButtonBurgerIsClicked(!buttonBurgerisClicked);
    }
  ...
  return (
    <nav className="NavBar__nav">
      ...
      <i className="fas fa-bars web-font NavBar__nav__i--button-burger"
            onClick={handleNavButtonBurger}></i>
